<header class="contact-heading">
  ...
  <h1>Contatto</h1>
  <p>Puoi scriverci in italiano, francese, inglese o spagnolo.</p>
</header>
...
<form class="contact-form" data-contact-form data-recipient="">
  ...
  <div class="contact-actions contact-field-wide">
    ...
    <p class="contact-status" data-contact-status aria-live="polite">L’indirizzo di destinazione sarà configurato nella fase successiva.</p>
  </div>
</form>
